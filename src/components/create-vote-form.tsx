...
export function CreateVoteForm() {
        ...
        endTime: new Date(
          Date.now() +
            Number.parseInt(formData.duration) *
              (formData.durationUnit === "hours" ? 60 * 60 * 1000 : 60 * 1000)
        ).toISOString(),
        totalVotes: 0,
        isActive: true,
  ...
  const isFormValid = () => {
    ...
    const hasValidChoices =
      formData.choices.filter((choice) => choice.text.trim() !== "").length >=
      2;
        ...
        <Card className="border-davinci-callout-border">
          <CardContent className="p-12 text-center">
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-davinci-black-alt mb-2">
                  Vote Launched Successfully!
                </h2>
                <p className="text-davinci-black-alt/80">
                  Your vote has been deployed to the DAVINCI network and is now
                  live.
                </p>
              </div>
              <div className="bg-davinci-digital-highlight p-4 rounded-lg border border-davinci-callout-border max-w-md mx-auto">
                <p className="text-sm text-davinci-black-alt/80">
                  Redirecting you to the vote page where you can share it with
                  the community...
                </p>
              </div>
            </div>
          ...
          <CardContent className="space-y-6 pt-6 bg-davinci-text-base">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-davinci-black-alt">
                  Choices ({formData.choices.length}/6)
                </Label>
                <Button
                  type="button"
                  variant="outline"
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="bg-davinci-paper-base text-davinci-black-alt border-davinci-callout-border max-w-xs">
                    <p>
                      This miniapp offers 3 voting methods, but DAVINCI allows
                      any type of voting method thanks to the use of a{" "}
                      <a
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, votingMethod: value })
                }
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label
                    ...
                    className="text-davinci-black-alt"
                  >
                    Single Choice
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-davinci-paper-base text-davinci-black-alt border-davinci-callout-border">
                      <p>
                        Voters can select multiple options within specified
                        limits
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-davinci-paper-base text-davinci-black-alt border-davinci-callout-border">
                      <p>
                        Voters allocate credits to express preference intensity
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              {formData.votingMethod === "multiple-choice" && (
                <div className="bg-davinci-digital-highlight p-4 rounded-lg space-y-4 border border-davinci-callout-border">
                  <h4 className="font-medium text-davinci-black-alt">
                    Multiple Choice Configuration
                  </h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label
                        htmlFor="min-selections"
                        className="text-davinci-black-alt"
                      >
                        Minimum Selections
                      </Label>
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFormData({ ...formData, multipleChoiceMin: value })
                        }
                      >
                        ...
                        <SelectContent className="bg-davinci-paper-base border-davinci-callout-border">
                          {Array.from(
                            { length: Math.min(formData.choices.length, 6) },
                            (_, i) => (
                              <SelectItem
                                key={i + 1}
                                value={(i + 1).toString()}
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFormData({ ...formData, multipleChoiceMax: value })
                        }
                      >
                        <SelectTrigger className="border-davinci-callout-border">
                          <SelectValue />
                  ...
                  <p className="text-sm text-davinci-black-alt/80">
                    Voters must select between {formData.multipleChoiceMin} and{" "}
                    {formData.multipleChoiceMax} options.
                  </p>
                </div>
              )}
              ...
              {formData.votingMethod === "quadratic-voting" && (
                <div className="bg-davinci-digital-highlight p-4 rounded-lg space-y-4 border border-davinci-callout-border">
                  ...
                  <p className="text-sm text-davinci-black-alt/80">
                    Each voter will receive {formData.quadraticCredits} credits
                    to allocate across choices. The cost to vote increases
                    quadratically (1 vote = 1 credit, 2 votes = 4 credits,
                    etc.).
                  </p>
                </div>
              )}
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="bg-davinci-paper-base text-davinci-black-alt border-davinci-callout-border max-w-xs">
                    <p>
                      This miniapp showcases two census types, but the DAVINCI
                      Protocol is designed to be compatible with a wide range of
                      census types and authentication methods. Censuses are
                      based on snapshots that are automatically updated every
                      hour.
                    </p>
                  </TooltipContent>
                </Tooltip>
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, censusType: value })
                }
              >
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                  ...
                  {formData.censusType === "ethereum-wallets" && (
                    <div className="ml-6 bg-davinci-digital-highlight p-4 rounded-lg border border-davinci-callout-border">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-2">
                          <p className="text-sm font-medium text-davinci-black-alt">
                            Ethereum Wallet Requirements
                          </p>
                          <p className="text-sm text-davinci-black-alt/80">
                            Only wallets with a minimum balance of{" "}
                            <strong>0.001 ETH</strong> can participate in this
                            vote.
                          </p>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="bg-davinci-paper-base text-davinci-black-alt border-davinci-callout-border">
                        <p>
                          Wallets verified through Holonym's identity system
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  {formData.censusType === "holonym-passport" && (
                    <div className="ml-6 bg-davinci-digital-highlight p-4 rounded-lg border border-davinci-callout-border">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-davinci-black-alt">
                            Holonym Passport Requirements
                          </p>
                          <p className="text-sm text-davinci-black-alt/80">
                            Only wallets with verified Holonym Passport
                            credentials can participate in this vote.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-davinci-digital-highlight p-4 rounded-lg border border-davinci-callout-border">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-davinci-black-alt/80">
                        Your vote will be active for {formData.duration}{" "}
                        {formData.durationUnit}. Once started, this cannot be
                        changed.
                      </p>
                    </div>
                  </div>
          ...
          <CardContent className="space-y-6 pt-6 bg-davinci-text-base">
            ...
            <div className="text-center space-y-4">
              <div className="flex justify-center items-center mx-auto">
                <img
                  src="/images/davinci-icon.png"
                  alt="DAVINCI"
                  className="w-16 h-16"
                />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-davinci-black-alt">
                  Ready to Launch
                </h3>
                <p className="text-davinci-black-alt/80">
                  Your vote will be deployed to the DAVINCI network and become
                  immediately active.
                </p>
              </div>
              <Button
              ...
              {isLaunching && (
                <div className="bg-davinci-digital-highlight p-4 rounded-lg border border-davinci-callout-border max-w-md mx-auto">
                  <p className="text-sm text-davinci-black-alt/80">
                    Deploying your vote to the DAVINCI network. This may take a
                    few moments...
                  </p>
                </div>
              )}
