                    ...
                    <div className='relative'>
                      <div className='w-full bg-davinci-soft-neutral rounded-full h-2'>
                        <div
                          ...
                          style={{
                            width: `${Math.min(
                              (selectedChoices.length / Number.parseInt(voteData.multipleChoiceMax || '2')) * 100,
                              100
                            )}%`,
                          }}
                        />
                      ...
                      <div
                        ...
                        style={{
                          left: `${
                            (Number.parseInt(voteData.multipleChoiceMin || '1') /
                              Number.parseInt(voteData.multipleChoiceMax || '2')) *
                            100
                          }%`,
                        }}
                      />
                    ...
                    <div className='flex items-start gap-2'>
                      ...
                      <div>
                        ...
                        <p className='text-xs text-red-700'>
                          {selectedChoices.length < Number.parseInt(voteData.multipleChoiceMin || '1')
                            ? `You must select at least ${voteData.multipleChoiceMin} choice${
                                voteData.multipleChoiceMin !== '1' ? 's' : ''
                              }.`
                            : `You can select at most ${voteData.multipleChoiceMax} choice${
                                voteData.multipleChoiceMax !== '1' ? 's' : ''
                              }.`}
                        </p>
                      </div>
                    </div>
