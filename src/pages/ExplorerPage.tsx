...
const generateDummyData = (): VotingProcess[] => {
  const types: ("Single Choice" | "Multiple Choice" | "Quadratic")[] = [
    "Single Choice",
    "Multiple Choice",
    "Quadratic",
  ];
    ...
    const interval = setInterval(() => {
      setAllVotes((currentProcesses) => {
        ...
        updatedProcesses[randomIndex] = {
          ...updatedProcesses[randomIndex],
          votesCount:
            updatedProcesses[randomIndex].votesCount + additionalVotes,
          points:
            updatedProcesses[randomIndex].points +
            Math.floor(additionalVotes * 0.8),
        };
    ...
    <div className="px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-davinci-black-alt/80 max-w-2xl mx-auto">
            A simple explorer to view voting processes created on the DAVINCI
            network. Voting processes earn points based on the number of votes
            cast, encouraging active participation.
          </p>
        </div>
                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader className="bg-davinci-paper-base">
                        <TableRow>
                          <TableHead className="text-davinci-black-alt min-w-[200px]">
                            Title
                          </TableHead>
                          <TableHead className="text-davinci-black-alt min-w-[120px]">
                            Creator
                          </TableHead>
                          <TableHead className="text-davinci-black-alt min-w-[140px]">
                            Transaction
                          </TableHead>
                          <TableHead className="text-davinci-black-alt text-center min-w-[120px]">
                            Type
                          </TableHead>
                          <TableHead className="text-davinci-black-alt text-right min-w-[80px]">
                            Votes
                          </TableHead>
                          <TableHead className="text-davinci-black-alt text-right min-w-[80px]">
                            Points
                      ...
                      <TableBody>
                        {filteredProcesses.map((process) => (
                          <TableRow
                            key={process.id}
                            className="hover:bg-davinci-paper-base/20"
                          >
                            <TableCell className="font-medium text-davinci-black-alt">
                              <div className="max-w-[200px]">
                                <div className="truncate">
                                  {process.title.length > 40
                                    ? `${process.title.substring(0, 40)}...`
                                    : process.title}
                                </div>
                                <div className="text-xs text-davinci-black-alt/60 mt-1">
                                  {process.timestamp}
                                </div>
                              </div>
                            </TableCell>
                                ...
                                className={`
                                  ${
                                    process.type === "Single Choice"
                                      ? "bg-davinci-soft-neutral"
                                      : ""
                                  }
                                  ${
                                    process.type === "Multiple Choice"
                                      ? "bg-davinci-digital-highlight"
                                      : ""
                                  }
                                  ${
                                    process.type === "Quadratic"
                                      ? "bg-davinci-secondary-accent"
                                      : ""
                                  }
                            ...
                            <TableCell className="text-right text-davinci-black-alt">
                              {process.votesCount}
                            </TableCell>
                      ...
                      <TableBody>
                        {filteredProcesses.length > 0 ? (
                          ...
                          <TableRow>
                            <TableCell
                              colSpan={6}
                              className="text-center py-8 text-davinci-black-alt/60"
                            >
                              {searchTerm
