...
const sampleCompletedVoteData = {
  ...
  question: 'How should the DAVINCI Community Treasury allocate the Q4 2024 budget?',
  description:
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-8'>
          <div className='inline-flex items-center gap-2 px-4 py-2 bg-davinci-digital-highlight rounded-full border border-davinci-callout-border mb-4'>
            ...
            <span className='text-sm font-medium text-davinci-black-alt'>Vote Completed</span>
          </div>
          ...
          <p className='text-davinci-black-alt/80 max-w-3xl mx-auto'>
            This is a demonstration of a completed voting process on the DAVINCI network. The community has successfully
            decided on the Q4 2024 budget allocation with strong participation from token holders.
          </p>
        </div>
        ...
        <div className='mb-8'>
          <div className='bg-davinci-secondary-accent/20 border border-davinci-secondary-accent/40 rounded-lg p-4'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                <h3 className='font-semibold text-davinci-black-alt mb-1'>Demo Vote Results</h3>
                <p className='text-sm text-davinci-black-alt/80'>
                  This page demonstrates how completed votes appear on the DAVINCI platform. The results shown are
                  simulated for demonstration purposes and showcase the platform's capability to handle complex
                  community governance decisions with transparent, verifiable outcomes.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
          ...
          <div className='lg:col-span-4 space-y-6'>
            <TotalVotesCard voteData={voteData} currentTotalVotes={currentTotalVotes} voteEnded={true} />
            ...
            <div className='bg-davinci-paper-base/80 border border-davinci-callout-border rounded-lg p-6'>
              <h3 className='font-semibold text-davinci-black-alt mb-3'>About This Demo</h3>
              <div className='space-y-3 text-sm text-davinci-black-alt/80'>
                <div className='flex items-start gap-2'>
                  ...
                  <p>
                    <strong>Realistic Data:</strong> Vote counts and percentages reflect authentic community engagement
                    patterns.
                  </p>
                </div>
                <div className='flex items-start gap-2'>
                  <div className='w-1.5 h-1.5 bg-davinci-black-alt rounded-full mt-2 flex-shrink-0'></div>
                  <p>
                    <strong>Complete Workflow:</strong> Demonstrates the full voting lifecycle from creation to final
                    results.
                  </p>
                </div>
                <div className='flex items-start gap-2'>
                  <div className='w-1.5 h-1.5 bg-davinci-black-alt rounded-full mt-2 flex-shrink-0'></div>
                  <p>
                    <strong>Governance Ready:</strong> Shows how DAVINCI can handle complex community decisions with
                    multiple options.
                  </p>
                </div>
              </div>
        ...
        <div className='mt-16 grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-davinci-digital-highlight/30 border border-davinci-callout-border rounded-lg p-6'>
            <h4 className='font-semibold text-davinci-black-alt mb-3'>Transparent Results</h4>
            <p className='text-sm text-davinci-black-alt/80'>
              All vote results are cryptographically verifiable and permanently recorded on the blockchain, ensuring
          ...
          <div className='bg-davinci-soft-neutral/30 border border-davinci-callout-border rounded-lg p-6'>
            <h4 className='font-semibold text-davinci-black-alt mb-3'>Community Driven</h4>
            <p className='text-sm text-davinci-black-alt/80'>
              This vote demonstrates how communities can make important decisions collectively, with every eligible
              member having an equal voice in the outcome.
            </p>
          </div>

          <div className='bg-davinci-secondary-accent/20 border border-davinci-callout-border rounded-lg p-6'>
            <h4 className='font-semibold text-davinci-black-alt mb-3'>Secure Process</h4>
            <p className='text-sm text-davinci-black-alt/80'>
              The voting process includes anti-coercion protection, anonymous voting, and encrypted results until the
