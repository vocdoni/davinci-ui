      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-davinci-black-alt/80 max-w-2xl mx-auto">
            Integrate the DAVINCI SDK into your project to leverage
          ...
          <Card className="border-davinci-callout-border">
            ...
            <CardContent className="space-y-6 pt-6 bg-davinci-text-base">
              <p className="text-davinci-black-alt/80">
                The DAVINCI SDK provides the tools you need to build voting
                functionalities into your applications.
              </p>

              <p className="text-davinci-black-alt/80">
                To start using the DAVINCI SDK, you'll typically need to install
                it via your preferred package manager (e.g., npm, yarn). The SDK
                allows you to create, manage, and interact with votes on the
                Vocdoni network.
              </p>
...
createNewVote();`}</code>
              ...
              <p className="text-davinci-black-alt/80">
                For detailed installation instructions, API reference, and usage
                examples, please refer to our official GitHub repository.
              </p>
            ...
            <CardContent className="space-y-4 pt-6 bg-davinci-text-base">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-davinci-black-alt/80">
                    <strong className="text-davinci-black-alt">
                      Create various types of votes
                    </strong>{" "}
                    (single choice, multi-choice, quadratic).
                  </p>
                </div>
