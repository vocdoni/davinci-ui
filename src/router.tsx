  ...
  <div className="px-4">
    <div className="max-w-7xl mx-auto">
      <div className="text-center py-16">
        ...
        <p className="text-davinci-black-alt/80 mt-2">
          Preparing the completed vote demonstration
        </p>
      </div>
    </div>
  </div>
...
const PublicVoteSampleEndPage = lazy(
  () => import("./pages/PublicVoteSampleEndPage")
);
